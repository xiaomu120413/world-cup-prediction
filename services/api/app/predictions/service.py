...
class BaselinePredictionService:
    ...
    def recompute(
        ...
        selected_kind = model_kind or ("baseline" if model_version.startswith("baseline") else "small_outcome")
    ...
    def build_small_outcome_prediction(self, row, runtime: SmallOutcomeRuntime) -> dict:
        ...
        baseline_prediction["probabilities"] = normalize_probabilities(probabilities)
        baseline_prediction.update(
            {
